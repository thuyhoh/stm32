...
#define SPI4_BASE					((SPI_RegDef_t *)SPI4_BASEADDR)
#define SPI5_BASE					((SPI_RegDef_t *)SPI5_BASEADDR)
#define SPI6_BASE					((SPI_RegDef_t *)SPI6_BASEADDR)
...
#define SYSCFG_PCLK_EN()			RCC_BASE->APB2ENR |= (1 << 14)
...
#define GPIOA_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 0)
#define GPIOB_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 1)
#define GPIOC_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 2)
#define GPIOD_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 3)
#define GPIOE_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 4)
#define GPIOF_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 5)
#define GPIOG_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 6)
#define GPIOH_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 7)
#define GPIOI_PCLK_DIS() 			RCC_BASE->AHB1ENR &= (uint32_t)~(1 << 8)

/* Disable Clock for SYSCFG*/
#define SYSCFG_PCLK_DIS()			RCC_BASE->APB2ENR &= (uint32_t)~(1 << 14)
 ...
 */
#define GPIOA_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<0); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<0);}while(0)
#define GPIOB_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<1); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<1);}while(0)
#define GPIOC_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<2); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<2);}while(0)
#define GPIOD_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<3); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<3);}while(0)
#define GPIOE_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<4); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<4);}while(0)
#define GPIOF_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<5); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<5);}while(0)
#define GPIOG_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<6); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<6);}while(0)
#define GPIOH_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<7); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<7);}while(0)
#define GPIOI_REG_RESET()			do{RCC_BASE->AHB1RSTR |= (1<<8); RCC_BASE->AHB1RSTR &= (uint32_t)~(1<<8);}while(0)
